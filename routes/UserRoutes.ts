...
router.get('/:userId/messages' ,getAccountInfo, getMessages);
...
//researched and found to handle images in backend, best to use multer package o be used as temp storage in the request obj to be able to get the picture data
